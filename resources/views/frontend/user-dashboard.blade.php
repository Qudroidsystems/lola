                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            <div class="myaccount-tab-menu nav" role="tablist">
                                ...
                                <a href="#download" data-bs-toggle="tab"><i class="fa fa-cloud-download"></i> Downloads</a>
                            ...
                            <div class="tab-content" id="myaccountContent">
                                ...
                                <div class="tab-pane fade show active" id="dashboard" role="tabpanel">
                                    <div class="myaccount-content">
                                        ...
                                        <p>From your dashboard, you can check your orders, manage addresses, and edit account details.</p>
                                    </div>
                                </div>
                               ...
                               <!-- Orders Section -->
                                ...
                                <div class="tab-pane fade" id="address" role="tabpanel">
                                    <div class="myaccount-content">
                                        ...
                                        @endif
                                        <a href="#" class="btn-add-to-cart"><i class="fa fa-edit"></i> Edit Address</a>
                                    </div>
                                </div>
                                ...
                                <div class="tab-pane fade" id="account-info" role="tabpanel">
                                    <div class="myaccount-content">
                                        ...
                                        <form action="{{ route('user.update') }}" method="POST">
                                            ...
                                            <button class="btn-add-to-cart">Save Changes</button>
                                        </form>
                                    </div>
                                </div>
