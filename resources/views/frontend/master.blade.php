        ...
        <div class="row">
            ...
            <div class="col-3 col-lg-1 col-xl-2 m-auto">
                <a href="index.html" class="logo-area">
                    <img src="{{ asset('ruby/ruby/assets/img/logo-black.png')}}" alt="Logo" class="img-fluid"/>
                </a>
            </div>
            <!-- Logo Area End -->
                                    ...
                                    <div class="single-cart-item d-flex">
                                        ...
                                        <div class="product-details">
                                            ...
                                            <div class="cal d-flex align-items-center">
                                                ...
                                                <span class="price">${{ number_format($item->product->base_price, 2) }}</span>
                                            </div>
                                        </div>
                ...
                <div class="row">
                    <div class="col-lg-12 text-center">
                        <div class="follow-content-wrap">
                            <a href="index.html" class="logo"><img src="{{ asset('ruby/ruby/assets/img/logo.png')}}" alt="logo"/></a>
