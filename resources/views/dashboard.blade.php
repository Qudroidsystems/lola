                    ...
                    <div class="row g-5 g-xl-10 mb-xl-10">
                            ...
                            <div class="card card-flush h-md-50 mb-5 mb-xl-10">
                                    ...
                                    <div class="card-title d-flex flex-column">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <span class="badge badge-light-{{ $earningsChange >= 0 ? 'success' : 'danger' }} fs-base">
                                                ...
                                                {{ number_format(abs($earningsChange), 1) }}%
                                            </span>
                                        </div>
                                ...
                                <div class="card-body pt-2 pb-4 d-flex align-items-center">
                                    ...
                                    <div class="d-flex flex-column content-justify-center w-100">
                                        @foreach (array_slice($categorySales, 0, 3) as $category => $total)
                                ...
                                <div class="card-header pt-5">
                                    <div class="card-title d-flex flex-column">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <span class="badge badge-light-{{ $ordersChange >= 0 ? 'success' : 'danger' }} fs-base">
                                                <i class="ki-duotone ki-arrow-{{ $ordersChange >= 0 ? 'up' : 'down' }} fs-5 text-{{ $ordersChange >= 0 ? 'success' : 'danger' }} ms-n1">
                                                    <span class="path1"></span><span class="path2"></span>
                                                </i>
                                ...
                                <div class="card-body d-flex align-items-end pt-0">
                                    <div class="d-flex align-items-center flex-column mt-3 w-100">
                                        <div class="d-flex justify-content-between w-100 mt-auto mb-2">
                                            ...
                                            <span class="fw-bold fs-6 text-gray-400">{{ round(($ordersThisMonth / 3000) * 100) }}%</span>
                                        </div>
                        ...
                        <div class="col-md-6 col-lg-6 col-xl-6 col-xxl-3 mb-md-5 mb-xl-10">
                                    ...
                                    <div class="card-title d-flex flex-column">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <span class="badge badge-light-{{ $avgSalesChange >= 0 ? 'success' : 'danger' }} fs-base">
                                                ...
                                                {{ number_format(abs($avgSalesChange), 1) }}%
                                            </span>
                                        </div>
                            ...
                            <div class="card card-flush h-md-50 mb-xl-10">
                                <div class="card-header pt-5">
                                    <div class="card-title d-flex flex-column">
                                        <span class="fs-2hx fw-bold text-dark me-2 lh-1 ls-n2">{{ number_format($newCustomersCount, 0) }}</span>
                                ...
                                <div class="card-body d-flex flex-column justify-content-end pe-0">
                                    ...
                                    <div class="symbol-group symbol-hover flex-nowrap">
                                        @foreach ($recentCustomers as $customer)
                                            <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" title="{{ $customer->name }}">
                                                <span class="symbol-label bg-{{ ['primary', 'warning', 'danger'][rand(0,2)] }} text-inverse-{{ ['primary', 'warning', 'danger'][rand(0,2)] }} fw-bold">{{ substr($customer->name, 0, 1) }}</span>
                                            </div>
                                        @endforeach
                                    ...
                                    <table class="table align-middle table-row-dashed fs-6 gy-3" id="kt_table_widget_4_table">
                                        ...
                                        <tbody class="fw-bold text-gray-600">
                                            @foreach ($productOrders as $order)
                                                <tr>
                                                    <td>
                                                        <a href="#" class="text-gray-800 text-hover-primary">#{{ $order['id'] }}</a>
                                                    </td>
