            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <form action="{{ route('product.store') }}" method="POST" id="kt_ecommerce_add_product_form"
                    ...
                    <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                <select name="status" class="form-select mb-2" data-control="select2" data-hide-search="true"
                                        data-placeholder="Select status" id="kt_ecommerce_add_product_status_select" required>
                        ...
                        <!--begin::Relations Card-->
                        <div class="card card-flush py-4">
                            <div class="card-header">
                                <div class="card-title"><h2>Product Relations</h2></div>
                            </div>
                            <div class="card-body pt-0">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade show active" id="kt_ecommerce_add_product_general">
                                <div class="d-flex flex-column gap-7 gap-lg-10">
                                    ...
                                    <!-- Gallery Images -->
                                    <div class="card card-flush py-4">
                                        <div class="card-header"><div class="card-title"><h2>Media</h2></div></div>
                                        <div class="card-body pt-0">
                                            <div class="fv-row mb-2">
                                                <input type="file" name="images[]" multiple class="form-control" accept="image/*" />
                                                <div class="text-muted fs-7 mt-3">Upload product gallery images (optional).</div>
                                            </div>
