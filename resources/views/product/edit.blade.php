                    ...
                    <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body text-center pt-0">
                                ...
                                <div class="image-input image-input-outline {{ $product->thumbnail ? '' : 'image-input-empty' }} image-input-placeholder mb-3" data-kt-image-input="true">
                                    <div class="image-input-wrapper w-150px h-150px" style="{{ $product->thumbnail ? 'background-image: url(' . asset($product->thumbnail) . ')' : '' }}"></div>
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                ...
                                @error('selected_tag_ids')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                                <div class="text-muted fs-7">Add tags to a product.</div>
                                <a href="{{ route('tag.create') }}" class="btn btn-light-primary btn-sm mb-10">
                                ...
                                <select name="unit[]" id="unit" class="form-select mb-2" data-control="select2" multiple required>
                                    ...
                                    @foreach ($units as $unit)
                                        <option value="{{ $unit->id }}" {{ $product->units->contains($unit->id) ? 'selected' : '' }}>{{ $unit->name }}</option>
                                    @endforeach
                                </select>
                                @error('unit')
                                    <div class="alert alert-danger">{{ $message }}</div>
                            ...
                            <div class="card-body pt-0">
                                ...
                                <select name="brand[]" id="brand" class="form-select mb-2" data-control="select2" multiple required>
                                    ...
                                    @foreach ($brands as $brand)
                                        <option value="{{ $brand->id }}" {{ $product->brands->contains($brand->id) ? 'selected' : '' }}>{{ $brand->name }}</option>
                                    @endforeach
                                </select>
                                @error('brand')
                                    <div class="alert alert-danger">{{ $message }}</div>
                            ...
                            <div class="card-body pt-0">
                                ...
                                <select name="warehouses[]" id="warehouses" class="form-select mb-2" data-control="select2" multiple required>
                                    ...
                                    @foreach ($stores as $store)
                                        <option value="{{ $store->id }}" {{ $product->warehouses->contains($store->id) ? 'selected' : '' }}>{{ $store->name }}</option>
                                    @endforeach
                                </select>
                                @error('warehouses')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                ...
                                <a href="{{ route('store.create') }}" class="btn btn-light-primary btn-sm mb-10">
                                    ...
                                    <div class="card card-flush py-4">
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div>
                                                ...
                                                <textarea id="description" name="description" class="d-none">{!! $product->description !!}</textarea>
                                                @error('description')
                                                    <div class="alert alert-danger">{{ $message }}</div>
                                                @enderror
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="image-preview-container mt-3">
                                                @foreach ($product->galleryImages as $image)
                                                    <img src="{{ asset($image->path) }}" alt="Product Image" width="100" class="me-2 mb-2">
                                                @endforeach
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card card-flush py-4">
                                        ...
                                        <div class="card-body pt-0">
                                            <div class="mb-10">
                                                ...
                                                <input type="text" class="form-control mb-2" name="meta_title" placeholder="Meta tag name" value="{{ old('meta_title', $product->meta_tag_title) }}" />
                                                @error('meta_title')
                                                    <div class="alert alert-danger">{{ $message }}</div>
                                                @enderror
                                            ...
                                            <div class="mb-10">
                                                ...
                                                <div id="kt_ecommerce_add_product_meta_description" name="kt_ecommerce_add_product_meta_description" class="min-h-100px mb-2">{!! $product->meta_tag_description !!}</div>
                                                <textarea id="meta_tag_description" name="meta_tag_description" class="d-none">{!! $product->meta_tag_description !!}</textarea>
                                            ...
                                            <div>
                                                ...
                                                <input id="kt_ecommerce_add_product_meta_keywords" name="meta_tag_keywords" class="form-control mb-2" value="{{ old('meta_tag_keywords', $product->meta_tag_keywords) }}" />
                                        ...
                                        <div class="card-body pt-0">
                                            <div class="mb-10 fv-row">
                                                <div class="w-100 w-md-800px">
                                                    ...
                                                    <input type="text" name="sku" id="sku" class="form-control mb-2" placeholder="Barcode Number" value="{{ old('sku', $product->sku) }}" required />
                                                    @error('sku')
                                                        <div class="alert alert-danger">{{ $message }}</div>
                                                    @enderror
                                                ...
                                                <div class="w-100 w-md-800px">
                                                    ...
                                                    <input type="text" name="barcode" class="form-control mb-2" placeholder="Barcode Number" value="{{ old('barcode', $product->barcode) }}" />
                                                    @error('barcode')
                                                        <div class="alert alert-danger">{{ $message }}</div>
                                                    @enderror
                                                ...
                                                <div class="w-100 w-md-800px">
                                                    ...
                                                    <div class="d-flex gap-3">
                                                        <input type="number" name="stock" class="form-control mb-2" placeholder="On shelf" value="{{ old('stock', $product->stock) }}" required />
                                                    </div>
                                                    @error('stock')
                                                        <div class="alert alert-danger">{{ $message }}</div>
                                                    @enderror
                                                ...
                                                <div class="w-100 w-md-800px">
                                                    ...
                                                    <div class="d-flex gap-3">
                                                        <input type="number" name="stock_alert" class="form-control mb-2" placeholder="Stock alert" value="{{ old('stock_alert', $product->stock_alert) }}" required />
                                                    </div>
                                                    @error('stock_alert')
                                                        <div class="alert alert-danger">{{ $message }}</div>
                                                    @enderror
                                                ...
                                                <div class="w-100 w-md-800px">
                                                    ...
                                                    <div class="d-flex gap-3">
                                                        <input type="number" name="price" class="form-control mb-2" placeholder="Price" value="{{ old('price', $product->base_price) }}" required />
                                                    </div>
                                                    @error('price')
                                                        <div class="alert alert-danger">{{ $message }}</div>
                                                    @enderror
                                                ...
                                                <div class="w-100 w-md-800px">
                                                    ...
                                                    <div class="d-flex gap-3">
                                                        <input type="number" name="sale_price" class="form-control mb-2" placeholder="Sale Price" value="{{ old('sale_price', $product->sale_price) }}" required />
                                                    </div>
                                                    @error('sale_price')
                                                        <div class="alert alert-danger">{{ $message }}</div>
                                                    @enderror
                                                ...
                                                <div class="w-100 w-md-800px">
                                                    ...
                                                    <select class="form-select" name="kt_ecommerce_add_product_options[0][discounttype]" required>
                                                        <option value="nodiscount" {{ old('kt_ecommerce_add_product_options.0.discounttype', $product->discounttype ?? 'nodiscount') == 'nodiscount' ? 'selected' : '' }}>No Discount</option>
                                                        <option value="percentage" {{ old('kt_ecommerce_add_product_options.0.discounttype', $product->discounttype ?? '') == 'percentage' ? 'selected' : '' }}>Percentage %</option>
                                                        <option value="fixed" {{ old('kt_ecommerce_add_product_options.0.discounttype', $product->discounttype ?? '') == 'fixed' ? 'selected' : '' }}>Fixed</option>
                                                    </select>
                                                    @error('kt_ecommerce_add_product_options.0.discounttype')
                                                        <div class="alert alert-danger">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                                <div class="w-100 w-md-800px">
                                                    ...
                                                    <div class="d-flex gap-3">
                                                        <input type="number" name="kt_ecommerce_add_product_options[0][percentage]" class="form-control mb-2" placeholder="Enter Percentage" value="{{ old('kt_ecommerce_add_product_options.0.percentage', $product->percentage ?? '') }}" />
                                                    </div>
                                                    @error('kt_ecommerce_add_product_options.0.percentage')
                                                        <div class="alert alert-danger">{{ $message }}</div>
                                                    @enderror
                                                ...
                                                <div class="w-100 w-md-800px">
                                                    ...
                                                    <div class="d-flex gap-3">
                                                        <input type="number" name="kt_ecommerce_add_product_options[0][fixed]" class="form-control mb-2" placeholder="Enter Fixed Discount Price" value="{{ old('kt_ecommerce_add_product_options.0.fixed', $product->fixed ?? '') }}" />
                                                    </div>
                                                    @error('kt_ecommerce_add_product_options.0.fixed')
                                                        <div class="alert alert-danger">{{ $message }}</div>
                                                    @enderror
                                                ...
                                                <div class="d-flex flex-wrap gap-5">
                                                    <div class="fv-row w-100 flex-md-root">
                                                        ...
                                                        <select class="form-select mb-2" name="tax" data-control="select2" data-hide-search="true" data-placeholder="Select an option">
                                                            <option value="0" {{ old('tax', $product->tax) == 0 ? 'selected' : '' }}>Tax Free</option>
                                                            <option value="1" {{ old('tax', $product->tax) == 1 ? 'selected' : '' }}>Taxable Goods</option>
                                                            <option value="2" {{ old('tax', $product->tax) == 2 ? 'selected' : '' }}>Downloadable Product</option>
                                                        </select>
                                                        @error('tax')
                                                            <div class="alert alert-danger">{{ $message }}</div>
                                                        @enderror
                                                    ...
                                                    <div class="fv-row w-100 flex-md-root">
                                                        ...
                                                        <input type="text" name="vat_amount" class="form-control mb-2" value="{{ old('vat_amount', $product->vat_amount) }}" />
                                                        @error('vat_amount')
                                                            <div class="alert alert-danger">{{ $message }}</div>
                                                        @enderror
                                                ...
                                                <div class="d-flex flex-wrap gap-5">
                                                    <div class="fv-row w-100 flex-md-root">
                                                        ...
                                                        <input type="date" name="manufacture" class="form-control mb-2" value="{{ old('manufacture', $product->manufactured) }}" />
                                                        @error('manufacture')
                                                            <div class="alert alert-danger">{{ $message }}</div>
                                                        @enderror
                                                    ...
                                                    <div class="fv-row w-100 flex-md-root">
                                                        ...
                                                        <input type="date" name="expiry" class="form-control mb-2" value="{{ old('expiry', $product->expiry) }}" />
                                                        @error('expiry')
                                                            <div class="alert alert-danger">{{ $message }}</div>
                                                        @enderror
                                                ...
                                                <div class="d-flex flex-stack">
                                                    <label class="form-check form-switch form-check-custom form-check-solid">
                                                        <input class="form-check-input" name="is_featured" type="checkbox" value="1" {{ old('is_featured', $product->is_featured) ? 'checked' : '' }} />
                                                        <span class="form-check-label fw-semibold text-muted">Featured Product</span>
                                                    </label>
                                                    <label class="form-check form-switch form-check-custom form-check-solid">
                                                        <input class="form-check-input" name="is_new" type="checkbox" value="1" {{ old('is_new', $product->is_new) ? 'checked' : '' }} />
                                                        <span class="form-check-label fw-semibold text-muted">New Product</span>
                                                    </label>
                                                    <label class="form-check form-switch form-check-custom form-check-solid">
                                                        <input class="form-check-input" name="on_sale" type="checkbox" value="1" {{ old('on_sale', $product->on_sale) ? 'checked' : '' }} />
