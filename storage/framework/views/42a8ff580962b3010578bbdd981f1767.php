    ...
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <?php endif; ?> <?php if(\Session::has('status')): ?>
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                <!--begin::Form-->
                <form action="<?php echo e(route('product.store')); ?>" method="POST" id="kt_ecommerce_add_product_form" class="form d-flex flex-column flex-lg-row" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <!--begin::Aside column-->
                    <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <!--begin::Button-->
                                <a href="<?php echo e(route('category.create')); ?>" class="btn btn-light-primary btn-sm mb-10"> <i class="ki-duotone ki-plus fs-2"></i> Create new category </a>
                                <!--end::Button-->
                                ...
                                <!--begin::Input-->
                                        ...
                                        <input type="hidden" id="_tags" name="_tags" value='<?php echo json_encode($tags, 15, 512) ?>' />
                            ...
                            <div class="card-body pt-0">
                                ...
                                <!--begin::Button-->
                                <a href="<?php echo e(route('unit.create')); ?>" class="btn btn-light-primary btn-sm mb-10"> <i class="ki-duotone ki-plus fs-2"></i> Create new Unit </a>
                                <!--end::Button-->
                            </div>
                            <!--end::Card body-->
                        </div>
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <!--end::Description-->
                                <!--begin::Button-->
                                <a href="<?php echo e(route('unit.create')); ?>" class="btn btn-light-primary btn-sm mb-10"> <i class="ki-duotone ki-plus fs-2"></i> Create new Store </a>
                                <!--end::Button-->
                            </div>
                            <!--end::Card body-->
                        </div>
