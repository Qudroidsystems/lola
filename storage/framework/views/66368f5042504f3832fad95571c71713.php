...
<div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true" id="kt_menu_notifications">
	<!--begin::Heading-->
    <div class="d-flex flex-column bgi-no-repeat rounded-top" style="background-image:url('<?php echo e(asset('html/assets/assets/media/misc/menu-header-bg.jpg')); ?>')">
        <!--begin::Title-->
 ...
 fs-2 text-info"></i>
			...
			<div class="py-3 text-center border-top">
                <a href="<?php echo e(asset('html/assets/pages/user-profile/activity.html')); ?>" class="btn btn-color-gray-600 btn-active-color-primary">
                    View All
        ...
        <div class="tab-pane fade show active" id="kt_topbar_notifications_2" role="tabpanel">
            ...
            <div class="d-flex flex-column px-9">
                ...
                <div class="text-center px-4">
                    <img class="mw-100 mh-200px" alt="image" src="<?php echo e(asset('html/assets/assets/media/illustrations/sketchy-1/1.png')); ?>"/>
                </div>
                <!--end::Illustration-->
            </div>
            <!--end::Wrapper-->
                ...
                <div class="row g-2">
                        ...
                        <div class="col-4">
                            <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                <img src="<?php echo e(asset('html/assets/assets/media/svg/brand-logos/amazon.svg')); ?>" class="w-25px h-25px mb-2" alt=""/>
                        ...
                        <div class="col-4">
                            <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                <img src="<?php echo e(asset('html/assets/assets/media/svg/brand-logos/angular-icon-1.svg')); ?>" class="w-25px h-25px mb-2" alt=""/>
                        ...
                        <div class="col-4">
                            <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                <img src="<?php echo e(asset('html/assets/assets/media/svg/brand-logos/atica.svg')); ?>" class="w-25px h-25px mb-2" alt=""/>
...
<!--end::Header-->
<?php /**PATH C:\xampp\htdocs\lola\resources\views/layouts/inc/header.blade.php ENDPATH**/ ?>