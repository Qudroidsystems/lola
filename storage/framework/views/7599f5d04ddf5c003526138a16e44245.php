...
<!--begin::Custom Javascript(used for this page only)-->
    ...
    <script src="<?php echo e(asset('html/assets/assets/js/custom/account/settings/deactivate-account.js')); ?>"></script>
<!--end::Custom Javascript-->
<!--end::Javascript-->
<?php /**PATH C:\xampp\htdocs\lola\resources\views/layouts/pages-assets/js/users-list-js.blade.php ENDPATH**/ ?>