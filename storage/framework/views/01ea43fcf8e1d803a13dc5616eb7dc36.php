            ...
            <div class="card card-flush">
                ...
                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                    ...
                    <div class="card-toolbar">
                        <!--begin::Add customer-->
                        <a href="<?php echo e(route('tag.create')); ?>" class="btn btn-primary">
                            Add Tag
                        </a>
                        <!--end::Add customer-->
                    </div>
    ...
    <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        <div class="ms-5">
                                            <!--begin::Title-->
                                            <a href="#" class="text-gray-800 text-hover-primary fs-5 fw-bold mb-1" data-kt-ecommerce-tag-filter="tag_name"><?php echo e($tag->name); ?></a>
                                            <!--end::Title-->
                                ...
                                <td class="text-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="<?php echo e(route('tag.edit', $tag->id)); ?>" class="btn btn-warning btn-sm">
                                                        Edit
                                            </a>
                                        </div>
                                        <!--end::Menu item-->
                                    ...
                                    <!--begin::Menu item-->
                                        ...
                                        data-url="<?php echo e(route('tag.destroy', $tag->id)); ?>"
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lola\resources\views/tag/index.blade.php ENDPATH**/ ?>