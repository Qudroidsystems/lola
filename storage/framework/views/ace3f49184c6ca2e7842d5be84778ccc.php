                                              ...
                                              <div  class="menu-item" >
                                                    ...
                                                    <a class="menu-link
                                                     <?php echo e(request()->is('brand*')
                                                        ? ' active' : ''); ?>"
                                                         href="<?php echo e(route('brand.index')); ?>" >
                                                        <span  class="menu-bullet" >
                                                            <span class="bullet bullet-dot">
                                                                </span>
                                                            </span>
                                              ...
                                              <div  class="menu-item" >
                                                    ...
                                                    <a class="menu-link
                                                     <?php echo e(request()->is('unit*')
                                                        ? ' active' : ''); ?>"
                                                         href="<?php echo e(route('unit.index')); ?>" >
                                                        <span  class="menu-bullet" >
                                                            <span class="bullet bullet-dot">
                                                                </span>
                                                            </span>
                                              ...
                                              <div  class="menu-item" >
                                                    ...
                                                    <a class="menu-link
                                                     <?php echo e(request()->is('variant*')
                                                        ? ' active' : ''); ?>"
                                                         href="<?php echo e(route('variant.index')); ?>" >
                                                        <span  class="menu-bullet" >
                                                            <span class="bullet bullet-dot">
                                                                </span>
                                                            </span>
...
<!--end::Sidebar-->
<?php /**PATH C:\xampp\htdocs\lola\resources\views/layouts/inc/sidebar.blade.php ENDPATH**/ ?>