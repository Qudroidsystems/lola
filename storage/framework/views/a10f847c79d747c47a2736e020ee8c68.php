...
<!--begin::Custom Javascript(used for this page only)-->
    <script src="<?php echo e(asset('html/assets/assets/js/custom/apps/ecommerce/catalog/store.js')); ?>"></script>
    <script src="<?php echo e(asset('html/assets/assets/js/custom/apps/ecommerce/catalog/save-store.js')); ?>"></script>
...
<!--end::Javascript-->
<?php /**PATH C:\xampp\htdocs\lola\resources\views/layouts/pages-assets/js/store-list-js.blade.php ENDPATH**/ ?>