...
<head>
    ...
    <!--=== Bootstrap CSS ===-->
    <link href="<?php echo e(asset('ruby/ruby/assets/css/vendor/bootstrap.min.css')); ?>" rel="stylesheet">
    <!--=== Font-Awesome CSS ===-->
    <link href="<?php echo e(asset('ruby/ruby/assets/css/vendor/font-awesome.css')); ?>" rel="stylesheet">
    <!--=== Plugins CSS ===-->
    <link href="<?php echo e(asset('ruby/ruby/assets/css/plugins.css')); ?>" rel="stylesheet">
    <!--=== Main Style CSS ===-->
    <link href="<?php echo e(asset('ruby/ruby/assets/css/style.css')); ?>" rel="stylesheet">

    <!-- Modernizer JS -->
    <script src="<?php echo e(asset('ruby/ruby/assets/js/vendor/modernizr-2.8.3.min.js')); ?>')}}"></script>
                    ...
                    <ul>
                        ...
                        <li class="settings"><a href="#"><i class="fa fa-cog"></i></a>
                            <div class="site-settings d-block d-sm-flex">
                                <dl class="my-account">
                                    ...
                                    <?php else: ?>
                                        <dd><a href="<?php echo e(route('login')); ?>">Login</a></dd>
                                        <dd><a href="<?php echo e(route('register')); ?>">Register</a></dd>
                                    <?php endif; ?>
                                </dl>
                            </div>
                        </li>
                        <li class="shop-cart">
                            <a href="<?php echo e(route('cart.index')); ?>">
                                ...
                                <span class="count"><?php echo e($cartCount ?? 0); ?></span>
                            </a>
                            <div class="mini-cart">
                                <div class="mini-cart-body">
                                    ...
                                    <div class="single-cart-item d-flex">
                                        ...
                                        <div class="product-details">
                                            <h2><a href="<?php echo e(route('product.show', $item->product->id)); ?>">
                                                <?php echo e(Str::limit($item->product->name, 20)); ?>
                                ...
                                <?php if($cartItems && $cartItems->isNotEmpty()): ?>
                                <div class="mini-cart-footer">
                                    <div class="cart-total mb-3">
                                        <strong>Total: $<?php echo e(number_format($cartTotal, 2)); ?></strong>
                                    </div>
                                    <a href="<?php echo e(route('checkout')); ?>" class="btn-add-to-cart">Checkout</a>
                                </div>
                                <?php endif; ?>
                            </div>
                        </li>
...
<div class="body-popup-modal-area">
    <span class="modal-close"><img src="<?php echo e(asset('ruby/ruby/assets/img/cancel.png')); ?>" alt="Close" class="img-fluid"/></span>
            ...
            <div class="callto-action-wrapper">
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        ...
                        <div class="single-callto-action d-flex">
                            <figure class="callto-thumb">
                                <img src="<?php echo e(asset('ruby/ruby/assets/img/air-plane.png')); ?>" alt="WorldWide Shipping"/>
                            </figure>
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <div class="single-callto-action d-flex">
                            <figure class="callto-thumb">
                                <img src="<?php echo e(asset('ruby/ruby/assets/img/support.png')); ?>" alt="Support"/>
                            </figure>
                            <div class="callto-info">
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <div class="single-callto-action d-flex">
                            <figure class="callto-thumb">
                                <img src="<?php echo e(asset('ruby/ruby/assets/img/money-back.png')); ?>" alt="Money Back"/>
                            </figure>
                            <div class="callto-info">
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <div class="single-callto-action d-flex">
                            <figure class="callto-thumb">
                                <img src="<?php echo e(asset('ruby/ruby/assets/img/cog.png')); ?>" alt="Guide"/>
                            </figure>
                            <div class="callto-info">
                ...
                <div class="row">
                    <div class="col-lg-12 text-center">
                        <div class="follow-content-wrap">
                            <a href="index.html" class="logo"><img src="<?php echo e(asset('ruby/ruby/assets/img/logo.png')); ?>" alt="logo"/></a>
                            ...
                            <!-- <a href="#"><img src="<?php echo e(asset('ruby/ruby/assets/img/payment.png')); ?>" alt="Payment Method"/></a> -->
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="imgage-gallery-carousel owl-carousel">
                            <div class="gallery-item">
                                <a href="#"><img src="<?php echo e(asset('ruby/ruby/assets/img/gallery-img-1.jpg')); ?>" alt="Gallery"/></a>
                            </div>
                            <div class="gallery-item">
                                <a href="#"><img src="<?php echo e(asset('ruby/ruby/assets/img/gallery-img-2.jpg')); ?>" alt="Gallery"/></a>
                            </div>
                            <div class="gallery-item">
                                <a href="#"><img src="<?php echo e(asset('ruby/ruby/assets/img/gallery-img-3.jpg')); ?>" alt="Gallery"/></a>
                            </div>
                            <div class="gallery-item">
                                <a href="#"><img src="<?php echo e(asset('ruby/ruby/assets/img/gallery-img-4.jpg')); ?>" alt="Gallery"/></a>
                            </div>
                            <div class="gallery-item">
                                <a href="#"><img src="<?php echo e(asset('ruby/ruby/assets/img/gallery-img-3.jpg')); ?>" alt="Gallery"/></a>
                            </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                <span aria-hidden="true"><img src="<?php echo e(asset('ruby/ruby/assets/img/cancel.png')); ?>" alt="Close" class="img-fluid"/></span>
            </button>
                                ...
                                <div class="product-thumb-carousel owl-carousel">
                                    <div class="single-thumb-item">
                                        <a href="single-product.html"><img class="img-fluid"
                                                                           src="<?php echo e(asset('ruby/ruby/assets/img/single-pro-thumb.jpg')); ?>"
                                                                           alt="Product"/></a>
                                    </div>

                                    <div class="single-thumb-item">
                                        <a href="single-product.html"><img class="img-fluid"
                                                                           src="<?php echo e(asset('ruby/ruby/assets/img/single-pro-thumb-2.jpg')); ?>"
                                                                           alt="Product"/></a>
                                    </div>

                                    <div class="single-thumb-item">
                                        <a href="single-product.html"><img class="img-fluid"
                                                                           src="<?php echo e(asset('ruby/ruby/assets/img/single-pro-thumb-3.jpg')); ?>"
                                                                           alt="Product"/></a>
                                    </div>

                                    <div class="single-thumb-item">
                                        <a href="single-product.html"><img class="img-fluid"
                                                                           src="<?php echo e(asset('ruby/ruby/assets/img/single-pro-thumb-4.jpg')); ?>"
                                                                           alt="Product"/></a>
                                    </div>
                                </div>
                            </div>
...
<!--=======================Javascript============================-->
<!--=== Jquery Min Js ===-->
<script src="<?php echo e(asset('ruby/ruby/assets/js/vendor/jquery.min.js')); ?>"></script>
<!--=== Jquery Migrate Min Js ===-->
<script src="<?php echo e(asset('ruby/ruby/assets/js/vendor/jquery-migrate.min.js')); ?>"></script>
<!--=== Bootstrap Min Js ===-->
<script src="<?php echo e(asset('ruby/ruby/assets/js/vendor/bootstrap.min.js')); ?>"></script>
<!--=== Plugins Min Js ===-->
<script src="<?php echo e(asset('ruby/ruby/assets/js/plugins.js')); ?>"></script>
