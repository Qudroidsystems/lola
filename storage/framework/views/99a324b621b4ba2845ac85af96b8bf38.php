...
<style>
    body {
        background-image: url('<?php echo e(asset('html/assets/assets/media/auth/bg4.jpg')); ?>');
    }

    [data-bs-theme="dark"] body {
        background-image: url('<?php echo e(asset('html/assets/assets/media/auth/bg4-dark.jpg')); ?>');
    }
</style>
<!--end::Page bg image-->
    ...
    <div class="d-flex flex-center w-lg-50 pt-15 pt-lg-0 px-10">
        ...
        <div class="d-flex flex-center flex-lg-start flex-column">
            ...
            <h2 class="text-white fw-normal m-0">
                <img alt="Logo" src="<?php echo e(asset('html/assets/assets/media/logos/logo.png')); ?>" class="h-100px app-sidebar-logo-default"/> Adrahstudios
            </h2>
            <!--end::Title-->
        </div>
        <!--begin::Aside-->
    ...
    <div class="fv-row mb-8" data-kt-password-meter="true">
        ...
        <div class="mb-1">
            ...
            <div class="position-relative mb-3">
                <input class="form-control bg-transparent <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"  required autocomplete="new-password"" type="password" placeholder="Password" name="password"/>
...
<!--end::Indicator progress-->        </button>
    ...
    <div class="text-gray-500 text-center fw-semibold fs-6">
        ...
        <a href="<?php echo e(route('login')); ?>" class="link-primary fw-semibold">
            Sign in
        </a>
    </div>
    <!--end::Sign up-->
...
<?php /**PATH C:\xampp\htdocs\lola\resources\views/auth/register.blade.php ENDPATH**/ ?>